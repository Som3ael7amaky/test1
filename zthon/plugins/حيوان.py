...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙏𝞝𝙇𝞝𝙃𝙊𝙉 ✘𓆪 </b> - @C_U_U_1 "
...
async def who(event):
    ...
    zel_dev = (5190136458, 627658332, 5092041118, 1050898456)
    ...
    if replied_user.id == 2031172223 or replied_user.id == 627658332 or replied_user.id == 1050898456:
