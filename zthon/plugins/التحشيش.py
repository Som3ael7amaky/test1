...
zel_dev = ( 2031172223, 5034762589, 5425537505)
...
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝙏𝙀𝙇𝙀𝙃𝙊𝙉☥✘ - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/S_EG_P) 🗑♻️𓆪\n**⎈•━━⊶𐂡•𝙏𝙀𝙇𝙀𝙃𝙊𝙉☥✘•𐂡⊷━━•⎈**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def permalink(mention):
    ...
    if user.id in zel_dev:
        return await edit_or_reply(mention, f"**╮ ❐ لك دي . . هـذا مـن مطـورين السـورس ي بـأف  ❏╰**")
    if user.id == 2031172223 or user.id == 5034762589 or user.id == 5425537505:
