...
async def _(event):
    zzevent = await edit_or_reply(event, "**╮ . افتـارات بيست بنـات ...🧚🏻‍♀🧚🏻‍♀╰**")
    try:
        zedph = [
            zelzal
            async for zelzal in event.client.iter_messages(
...
async def _(event):
    zzevent = await edit_or_reply(event, "**╮ . افتـارات تطقيـم حب ...♥️╰**")
    try:
        zedph = [
            zelzal
            async for zelzal in event.client.iter_messages(
...
async def _(event):
    zzevent = await edit_or_reply(event, "**╮ . افتـارات انمـي شبـاب ...𓅫╰**")
    try:
        zedph = [
            zelzal
            async for zelzal in event.client.iter_messages(
...
async def _(event):
    zzevent = await edit_or_reply(event, "**╮ . افتـارات انمـي بنـات ...𓅫╰**")
    try:
        zedph = [
            zelzal
            async for zelzal in event.client.iter_messages(
...
async def _(event):
    zzevent = await edit_or_reply(event, "**╮ . افتـارات بنـات تمبلـر ...𓅫╰**")
    try:
        zedph = [
            zelzal
            async for zelzal in event.client.iter_messages(
