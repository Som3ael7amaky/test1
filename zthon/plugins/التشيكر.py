...
ZelzalChecler_cmd = (
    "𓆩 [✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامـر الصيـد والتشيكـر](t.me/C_U_U_1) 𓆪\n\n"
        ...
        try:
            ch = await zedub(
                functions.channels.CreateChannelRequest(
                    title="⎉ تشيكــر كرستين  ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 ⎉",
                    about="This channel to hunt username by - @C_U_U_1 ",
                )
            )
