...
ZelzalDV_cmd = (
    "𓆩 [ 𝙎𝙊𝙐𝙍𝘾𝞝 ✘  - اوامــر المطـور المســاعد](t.me/devpokemon) 𓆪\n\n"
    ...
    "\n𓆩 [𐇮 𝙏𝙀𝙇𝙀𝙃𝙊𝙉☥✘ الهہـيـٖ͡ـ͢ـبـه 𐇮](t.me/C_U_U_1) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت ايـگس انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝗬ᴇ𝘀𝗼𝗼 :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت ايـگس انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
