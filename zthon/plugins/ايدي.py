...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت ايـگس"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦"
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─ 𝑠𝑜𝑢𝑟𝑐𝑒 ✘ ─┄─┄─⋆"
...
# الـرتب الوهميـه كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    ...
    zel_dev = (2031172223, 5425537505, 5034762589)
    if user_id == 2031172223 or user_id == 5425537505 or user_id == 5034762589:
