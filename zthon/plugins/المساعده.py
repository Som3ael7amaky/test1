...
**- الوصـف :**
لـ عـرض اوامـر الاذاعـه الخاصـه بسـورس ايــ✘ــگس
...
async def _(event):
    await event.edit(
        "[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر المجمــوعــه 🛗](t.me/C_U_U_1) .\n\n**- اليك عـزيـزي شروحـات اوامـر المجمــوعــه :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر مكـافح التكــرار 🛡](t.me/C_U_U_1) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر المنــع 🚫](t.me/C_U_U_1) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر الاضـافه والتفليـش 👾](t.me/C_U_U_1) .\n\n**- اليك عـزيـزي شروحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر الفــارات 🧬](t.me/C_U_U_1) .\n\n**- اليك عـزيـزي شروحـات اوامـر الفــارات :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر فــارات الوقتــي 🕰](t.me/C_U_U_1) .\n\n**- اليك عـزيـزي شروحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/C_U_U_1) .\n\n**- اليك عـزيـزي شروحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر فــارات حمايـة الخــاص 🛄](t.me/C_U_U_1) .\n\n**- اليك عـزيـزي شروحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر فــارات الفحـص 🏮](t.me/C_U_U_1) .\n\n**- اليك عـزيـزي شروحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
**- ملاحظـه :**
هـذا الامـر حصـري فقط وخاص بـ سـورس ايــ✘ــگس بقية السورسات ماتحمـل دقـة HD ؟!
...
async def _(event):
    await event.edit(
        "[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر التسليـه والتحشيش 🏂🎃](t.me/C_U_U_1) .\n\n**- اليك عـزيـزي شروحـات اوامـر التسليـه والتحشيش :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر التسليـه 🏂](t.me/C_U_U_1) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر التحشيش 🎃](t.me/C_U_U_1) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر الالـعــاب 🎮🎳](t.me/C_U_U_1) .
**- الامـر :**
**⪼** `.بلاي`
**العــاب الانـلايـن لســورس ايــ✘ــگس 🕹**
**⪼** `.كت`
**اسئلـة كـت تـويت ⁉️**
**⪼** `.احكام`
...
**- الوصـف :**
العـاب سـورس ايــ✘ــگس ممطـروقـه جربهـن راح يعجبنـك 🥳💞
...
async def _(event):
    await event.edit(
        """[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر حمـايــة الخــاص 🛡](t.me/C_U_U_1) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - فــارات حمـايــة الخــاص 🛡](t.me/C_U_U_1) .
**⪼** `.اضف عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def _(event):
    await event.edit(
        """[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر الستـوريـات 🎆🏖](t.me/C_U_U_1) .
**- الامـر :**
`.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/C_U_U_1) .
**- الامـر :**
**⪼** `.بنات`
...
async def _(event):
    await event.edit(
        """[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر الاشتــراك الاجبــاري 🛗](t.me/C_U_U_1) .
**- الامـر :**
...
async def _(event):
    await event.edit(
        """[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر الصيـد & التشيكـر ❇️](t.me/C_U_U_1) .
...
async def _(event):
    await event.edit(
        """[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر تجميــع النقــاط 🛂](t.me/C_U_U_1) .
**- الامـر :**
**⪼** `.المليار`
...
async def _(event):
    await event.edit(
        """[ᯓ ✘ 𝚂𝙾𝚄𝚁𝙲𝙴 - اوامــر النشــر التلقــائي 🌐](t.me/C_U_U_1) .
**- الامـر :**
**⪼** `.تلقائي`
