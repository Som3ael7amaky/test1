    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://telegra.ph/file/c97bb8311350df2800ab8.mp4",

                caption="**•⎆┊تـم بـدء تشغـيل سـورس ايـگس الخاص بك .. بنجاح 🧸♥️**",

                buttons=[(Button.url("𝙏𝞝𝙇𝞝𝙃𝙊𝙉𖣳父✘", "https://t.me/C_U_U_1"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", "ايـ✘ـگس")
            ...
            await bot.send_message("@BotFather", f"- بـوت ايـگس المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            ...
            "اشعارات ايـگس", zedub, Config.TG_BOT_USERNAME, descript, photozed
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(
            ...
            "تخزين ايـگس", zedub, Config.TG_BOT_USERNAME, descript, photozed
