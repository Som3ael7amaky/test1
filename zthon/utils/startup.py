    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://graph.org/file/61a35e2f797aa6723764b.jpg",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس ايـگس الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("sᴏᴜʀᴄᴇ ✘", "https://t.me/C_U_U_1"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "𝙏𝞝𝙇𝞝𝙃𝙊𝙉 ✘")
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_file("@BotFather", "zthon/zilzal/Apic.jpg")
            await asyncio.sleep(3)
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "جروب السجـل ايـگس", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )
